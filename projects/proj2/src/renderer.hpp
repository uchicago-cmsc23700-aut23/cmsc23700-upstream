...
public:
    WireframeRenderer (Proj2 *app, vk::RenderPass rp, vk::DescriptorSetLayout vertDSLayout)
      : Renderer (app, rp)
    {
        std::vector<vk::DescriptorSetLayout> layouts = {vertDSLayout};
...
public:
    FlatRenderer (Proj2 *app, vk::RenderPass rp, vk::DescriptorSetLayout vertDSLayout)
      : Renderer (app, rp)
    {
        std::vector<vk::DescriptorSetLayout> layouts = {vertDSLayout};
